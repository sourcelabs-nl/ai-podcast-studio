...
- [x] 4.2 Restart the app (`./stop.sh && ./start.sh`) and regenerate one episode of the Agentic AI Podcast; confirm the generated MP3 no longer pronounces em-dashes
- [x] 4.3 Run `/code-review --all` and address any violations introduced by the change
