# episode-publication-approval Specification

## Purpose
Optional per-podcast gate that requires an episode to be explicitly approved for publication before any publisher will accept it, tracked per episode.
## Requirements
