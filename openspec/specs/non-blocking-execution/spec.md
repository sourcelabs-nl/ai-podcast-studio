...
## Purpose
Concurrency rules for the pipeline: non-blocking coroutine roots, blocking I/O confined to Dispatchers.IO, transactional work kept off dispatcher switches, and suspend provider/publisher abstractions.
## Requirements
