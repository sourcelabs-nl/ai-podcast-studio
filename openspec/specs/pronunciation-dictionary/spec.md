# Capability: Pronunciation Dictionary

## Purpose

Per-podcast pronunciation dictionary that injects IPA phoneme notation into LLM script guidelines so TTS providers pronounce proper nouns, brand names, and foreign names correctly.
## Requirements
