...
interface EpisodeArticleRepository : CrudRepository<EpisodeArticle, Long>, EpisodeArticleRepositoryCustom {
    ...
    @Modifying
    @Query("INSERT OR IGNORE INTO episode_articles (episode_id, article_id, topic, topic_order, follow_up_context) VALUES (:episodeId, :articleId, :topic, :topicOrder, :followUpContext)")
    fun insertIgnore(
        episodeId: Long,
        articleId: Long,
        topic: String? = null,
