...
/** Covers the percentile read: which rows qualify as latency, and what the percentiles are. */
@SpringBootTest
class LlmCallLatencyTest {
    ...
    fun `percentiles are the nearest-rank durations`() {
        ...
        val latency = llmCallRepository.latencyPercentilesSince("2026-09-01T00:00:00Z").single()
    ...
    fun `each stage is reported separately`() {
        ...
        val byStage = llmCallRepository.latencyPercentilesSince("2026-09-01T00:00:00Z").associateBy { it.stage }
